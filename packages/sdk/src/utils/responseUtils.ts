...
import { CompositeResourceEntry, CrossplaneDesiredResources, CrossplaneResourceEntry, ExtraResourceRequirement, KubernetesMetadata, KubernetesResource } from "../types";
...
export class CrossplaneFunctionResponse {
    ...
    constructor(desired: CrossplaneDesiredResources, extraResources?: Record<string, KubernetesResource[]>) {
    ...
    requestExtraResource(name: string, requirement: ExtraResourceRequirement): KubernetesResource[] | undefined {
...
export function buildResponse(composite: Model<KubernetesResource>, extraResources?: Record<string, KubernetesResource[]>): CrossplaneFunctionResponse {
